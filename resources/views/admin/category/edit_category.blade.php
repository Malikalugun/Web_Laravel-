...
<input type="hidden" name="id" value={{$category->id}}>
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" id="title" name="title" aria-describedby="emailHelp" value="{{$category->title}}">    
    @error('title')
 ...
 @enderror
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="language" name="language" data-role="tagsinput" aria-describedby="emailHelp" value="{{$category->language}}">    
        @error('language')
        <span class="text-danger">{{ $message}}</span> 
     @enderror
    </div>
